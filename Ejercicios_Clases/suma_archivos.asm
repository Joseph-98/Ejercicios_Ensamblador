...
operacion_suma:
	...
	mov al, [texto + esi]
	adc al, [texto2 + esi]	; suma normal + carry(esta en binario)
	
	aaa;       		; toda operacion que conlleve acarreo hay que ajustar, aaa suma 6 digitos a la parte baja del registro
