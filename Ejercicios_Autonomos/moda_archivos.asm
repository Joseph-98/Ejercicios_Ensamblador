...
section .data
	...
	archivo db '/home/joshep/Escritorio/Ensamblador/arreglo.txt',0 ;-----pwd-->obtiene la ruta
      
	msj2 db 10, 'el resultado ha sido escrito en el disco duro.... por favor verifiquelo',10
	len_msj equ $- msj2
	archivo1 db '/home/joshep/Escritorio/Ensamblador/moda.txt',0 ;-----pwd-->obtiene la ruta
